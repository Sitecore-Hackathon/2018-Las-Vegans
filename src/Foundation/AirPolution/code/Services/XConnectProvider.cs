            ...
            {
                {
                    try
                    {
                        //Contact contact = new Contact(new ContactIdentifier("twitter5", "myrtlesitecore5", ContactIdentifierType.Known));
                        ...
                        //EmailAddressList emails = new EmailAddressList(new EmailAddress("myrtle5@test.test", true), "Home");
                        ...
                        var reference = new IdentifiedContactReference("twitter4", "myrtlesitecore4");
